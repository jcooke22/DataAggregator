...
class MinSpec extends ObjectBehavior
{
    ...
    function it_returns_the_correct_min_for_integers(
        ...
        // Act / Assert
        $this->aggregate($dataPointOne, $dataPointTwo, $dataPointThree)->shouldReturn(10);
    }

    function it_returns_the_correct_min_for_floats(
        DataPoint $dataPointOne,
        DataPoint $dataPointTwo,
        DataPoint $dataPointThree
    ) {
        ...
        // Act / Assert
        $this->aggregate($dataPointOne, $dataPointTwo, $dataPointThree)->shouldReturn(0.4);
    }
}